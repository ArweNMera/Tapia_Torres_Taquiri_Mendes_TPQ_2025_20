...
class MenuRecommender:
    ...
    def recomendar(
        self, clasificacion: str, alergias: list[str], edad_meses: int, top_n: int = 5
    ...
    def _calcular_score(self, menu: dict, req: dict, clasificacion: str) -> float:
        """
    ...
    def _generar_razon(self, menu: dict, req: dict, clasificacion: str) -> str:
    ...
    def _obtener_menus_db(self, req: dict, alergias: list[str]) -> list[dict]:
        """Obtiene menús de la base de datos."""
        # TODO: Implementar query a BD
        # Por ahora usar mock
        return self._obtener_menus_mock(req, alergias)

    def _obtener_menus_mock(self, req: dict, alergias: list[str]) -> list[dict]:
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    recomendaciones = recommender.recomendar(clasificacion="SEVERO", alergias=[], edad_meses=60)
    ...
    print("=" * 60)
    recomendaciones = recommender.recomendar(clasificacion="NORMAL", alergias=[], edad_meses=84)
