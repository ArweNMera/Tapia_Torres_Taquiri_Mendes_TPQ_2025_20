                ...
                datos.append(
                    {
                        ...
                        "altitude_m": np.random.choice(
                            [0, 500, 1000, 2500, 3500], p=[0.4, 0.2, 0.2, 0.15, 0.05]
                        ),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--samples", type=int, default=5000, help="Número de muestras sintéticas a generar"
    )
    parser.add_argument(
        "--solo-reales", action="store_true", help="Solo extraer datos reales (sin sintéticos)"
    )
