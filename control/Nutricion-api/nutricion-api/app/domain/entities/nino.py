...
class Nino:
    ...
    nin_fecha_nac: date
    nin_genero: str
    usr_id_tutor: int | None = None
    nin_dni: str | None = None
    ...
    def edad_en_meses(self, fecha_referencia: date | None = None) -> int:
    ...
    def edad_en_anios(self, fecha_referencia: date | None = None) -> int:
...
class Antropometria:
    ...
    ant_z_imc: Decimal | None = None
    ant_z_peso_edad: Decimal | None = None
    ant_z_talla_edad: Decimal | None = None
    creado_en: datetime | None = None
    actualizado_en: datetime | None = None
...
class Alergia:
    ...
    ta_id: int
    nina_severidad: str
    nina_notas: str | None = None
    nina_diagnosticado_en: date | None = None
    creado_en: datetime | None = None
