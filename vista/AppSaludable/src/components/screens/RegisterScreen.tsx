            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex items-start space-x-2 pt-1">
                ...
                <label htmlFor="terms" className="text-xs text-muted-foreground leading-tight">
                  Acepto los{' '}
                  <a href="/terms" target="_blank" rel="noreferrer" className="text-primary hover:text-primary-dark underline">
                    Términos de Servicio
                  </a>{' '}
                  y la{' '}
                  <a href="/privacy" target="_blank" rel="noreferrer" className="text-primary hover:text-primary-dark underline">
            ...
            <div className="grid grid-cols-2 gap-3">
              {socialProviders.map((provider) => (
                <Button
                  key={provider.label}
                  variant="outline"
                  className="w-full h-10 items-center justify-center space-x-2 border-border hover:bg-muted"
                  type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex items-start space-x-2 pt-1">
                ...
                <label htmlFor="terms-mobile" className="text-xs text-muted-foreground leading-tight">
                  Acepto los{' '}
                  <a href="/terms" target="_blank" rel="noreferrer" className="text-primary underline">Términos</a> y{' '}
                  <a href="/privacy" target="_blank" rel="noreferrer" className="text-primary underline">Política de Privacidad</a>
                </label>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              {socialProviders.map((provider) => (
                <Button
                  key={provider.label}
                  variant="outline"
                  className="h-9 justify-center space-x-2 text-xs"
                  onClick={provider.onClick}
                  disabled={isLoading}
                >
